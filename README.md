...
An automated and GUI-based molecular docking project investigating ligand-protein binding interactions (such as PRIMA-1 docking against target receptors like 1TUP) using **PyRx** and **AutoDock Vina**.
